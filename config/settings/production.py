"""
Django settings for AWFM Backend - Production

Use this for production deployment (Railway, etc.)
"""
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@awfm.org')
...
# Logging (production logging to stdout for Railway)
LOGGING = {
    'version': 1,
